    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero-dark">
      ...
      <div className="relative z-10 container-chapp section-chapp text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main heading split in two parts */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 animate-fade-in-up">
            <h1 className="text-hero sm:text-hero text-chapp-hero mb-6 animate-fade-in-up leading-tight">
            {t('Le tue idee sono ')}
            <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(59,130,246,0.6)]">
              grandi
            </span>
            {'. '}
          ...
          {/* Subtitle */}
          <p
            className="text-body-xl text-chapp-body mb-12 max-w-2xl mx-auto animate-fade-in-up leading-relaxed"
          ...
          >
            <button onClick={handleGetStarted} className="btn-chapp-primary group hover-glow-blue">
              {t('Accelera le tue idee')}
              <Rocket size={20} className="ml-2 group-hover:translate-x-1 transition-transform duration-300" />
            </button>
            <button onClick={handleDiscoverMore} className="btn-chapp-secondary group">
          ...
          {/* Stats */}
          <div
            className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto animate-fade-in-up"
