...
const ServicesSection = () => {
  ...
  return (
    <section id="servizi" className="section-padding bg-corporate-gray-light/30">
      <div className="container-corporate">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-display-md text-display text-corporate-gray-dark mb-6">
            ...
            <span className="text-corporate-blue">Ogni Esigenza</span>
          </h2>
          <p className="text-body-xl text-body max-w-3xl mx-auto">
            Offriamo una gamma completa di servizi di consulenza strategica, 
            progettati per trasformare le sfide in opportunità di crescita.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Content */}
              <h3 className="text-heading-lg text-heading mb-4">
                {service.title}
              </h3>
              ...
              <ul className="space-y-2 mb-6">
                {service.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-center text-body-sm text-body">
                    <div className="w-1.5 h-1.5 bg-corporate-blue rounded-full mr-3"></div>
                    {feature}
                  </li>
                ))}
              </ul>
              ...
              {/* CTA */}
              <button className="btn-corporate-ghost group/btn w-full justify-center flex items-center">
                Scopri di più
        ...
        <div className="text-center">
          <div className="bg-gradient-corporate rounded-3xl p-12 text-center">
            <h3 className="text-heading-xl text-corporate-white mb-4">
              Hai bisogno di una consulenza personalizzata?
            </h3>
            <p className="text-body-lg text-corporate-white/90 mb-8 max-w-2xl mx-auto">
